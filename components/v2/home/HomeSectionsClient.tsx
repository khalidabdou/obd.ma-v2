    ...
    <>
        ...
        <Container className="relative">
          <div className="mb-8 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold md:text-3xl">{t("home.shop_by_brand")}</h2>
                <p className="text-sm text-white/80">
                  {t("home.discover_brands")}
                </p>
              </div>
            </div>
            <Link
          ...
          {brands.length === 0 ? (
            <p className="text-white/80">{t("home.no_brands")}</p>
          ) : (
      ...
      <section className="bg-background py-14">
        <Container>
          ...
          {categories.length === 0 ? (
            <p className="text-muted-foreground">{t("home.no_categories")}</p>
          ) : (
